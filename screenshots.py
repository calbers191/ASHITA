...
if __name__ == '__main__':
    ...
    variant = MyVariant(copath_no, chr, pos, ref, alt, gene, transcript_id, c_dot)

    #print(variant.get_functional_predictions())

    patient_path = r'U:\ASHITA\screenshots\\' + variant.copath_no
